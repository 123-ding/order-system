...
> 飞行活动审批（初审、复审）由**石狮市交港局 运输安全股**负责；
> 放飞确认由**石狮市公安局 治安管理大队**负责。
...
flowchart TD
    ...
    G --> H{"审批节点1-初审<br>【审批部门】石狮市交港局 运输安全股<br>【审批职责】受理 / 材料完整性校验 / 合规初筛 / 风险标注<br>【输出】通过 / 驳回 / 补正"}
    H -->|驳回或补正| R1([审批驳回，通知申请人])
    H -->|通过| I{"审批节点2-复审<br>【审批部门】石狮市交港局 运输安全股<br>【审批职责】冲突审查 / 敏感空域复核 / 审批条件设置 / 归档留痕<br>【输出】批准（含条件）/ 不批准"}
    I -->|不批准| R2([审批驳回，通知申请人])
    I -->|批准| J([飞行活动审批通过])

    J --> K["计划起飞1小时前<br>提交放飞申请"]
    K --> L{"放飞审批节点<br>【审批部门】石狮市公安局 治安管理大队<br>【审批职责】核对已批及条件满足 / 起飞前1小时信息确认<br>临时管制与空域动态检查 / 最终放飞确认 / 记录留痕<br>【输出】允许起飞 / 不得起飞"}
